    ...
    return (
        <div className='flex justify-between h-16 shadow-sm      items-center bg-white mb-5'>
            <div className='flex items-center text-sm'>
                ...
                <p className='mx-4 text-lg font-medium hover:cursor-pointer'>Payouts</p>
                <div className='flex items-center text-sm hover:cursor-pointer'>
                    <div className="py-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
            ...
            <div className='flex gap-2 mx-4'>
                ...
                <div className='flex justify-center bg-gray-200 size-8 rounded-full  items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 fill-black">
