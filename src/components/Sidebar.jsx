...
const Sidebar = () => {
    ...
    return (
        <div className='bg-[#1E2640] text-white h-[100%] w-auto'>
            <div className='flex justify-between items-center p-5'>
                <div className='flex justify-center items-center gap-4'>
                    <img className='w-auto h-10' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6PDAuFtVIVolwS0WHxKTD86qtItQtCDrI7g&s" alt="pmg" />
                    <div>
                        <p className='font-medium'>Dukaan </p>
                        <a className='font-thin text-sm text-gray-300 underline' href="#">Visit Store</a>
                    </div>
            ...
            <ul className='px-2'>
                {list.map((e) => {
                    return <li key={e.id} className='flex py-2 pl-5 rounded-md text-gray-200 hover:cursor-pointer hover:bg-[#353C53]'>
                        <div className='pr-2'>
                            {e.icon}
                        </div>
